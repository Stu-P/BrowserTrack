(function () {
    ...
    function datacontext(common, serviceConfig) {
        ...
        function getBrowsers() {
            ...
            return $http.get(apiBaseUrl + 'Dashboard/GetAllBrowsers').then(
                function (response) {
        ...
        function getVersionChangeHistory() {
            return $http.get(apiBaseUrl + 'History/GetAllVersionChanges').then(
                function (response) {
                    return response.data;
                },
                function (httpError) {
        ...
        function updateBrowser(browser) {
            return $http.post(apiBaseUrl + 'Dashboard/Update', browser).then(
                 function (response) {
