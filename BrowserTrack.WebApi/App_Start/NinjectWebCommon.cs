//[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(BrowserTrack.WebApi.App_Start.NinjectWebCommon), "Start")]
//[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(BrowserTrack.WebApi.App_Start.NinjectWebCommon), "Stop")]

namespace BrowserTrack.WebApi.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IMailService>().To<BusinessHoursMailService>().InRequestScope();
